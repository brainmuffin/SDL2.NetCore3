...
namespace SDL2.NetCore3
{
    public static class SDL_render
    {
        ...
        private delegate IntPtr SDL_CreateSoftwareRenderer_SDL_Surface_t(ref SDL_surface.SDL_Surface surface);
        ...
        private delegate int SDL_SetTextureBlendMode_IntPtr_SDL_BlendMode_t(IntPtr texture, SDL_blendmode.SDL_BlendMode blendMode);
        ...
        public static int SDL_SetTextureBlendMode(IntPtr texture, SDL_blendmode.SDL_BlendMode blendMode) => s_SDL_SetTextureBlendMode_IntPtr_SDL_BlendMode_t(texture, blendMode);

        private delegate int SDL_GetTextureBlendMode_IntPtr_SDL_BlendMode_t(IntPtr texture, ref SDL_blendmode.SDL_BlendMode blendMode);
        ...
        private unsafe delegate int SDL_UpdateYUVTexture_IntPtr_SDL_Rect_byte_int_byte_int_byte_int_t(IntPtr texture, SDL_rect.SDL_Rect* rect, ref byte Yplane, int Ypitch, ref byte Uplane, int Upitch, ref byte Vplane, int Vpitch);
        ...
        private unsafe delegate int SDL_RenderSetViewport_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        private unsafe delegate void SDL_RenderGetViewport_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        public unsafe static void SDL_RenderGetViewport(IntPtr renderer, SDL_rect.SDL_Rect* rect) => s_SDL_RenderGetViewport_IntPtr_SDL_Rect_t(renderer, rect);

        private unsafe delegate int SDL_RenderSetClipRect_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        public unsafe static int SDL_RenderSetClipRect(IntPtr renderer, SDL_rect.SDL_Rect* rect) => s_SDL_RenderSetClipRect_IntPtr_SDL_Rect_t(renderer, rect);

        private unsafe delegate void SDL_RenderGetClipRect_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        private delegate int SDL_SetRenderDrawBlendMode_IntPtr_SDL_BlendMode_t(IntPtr renderer, SDL_blendmode.SDL_BlendMode blendMode);
        ...
        public static int SDL_SetRenderDrawBlendMode(IntPtr renderer, SDL_blendmode.SDL_BlendMode blendMode) => s_SDL_SetRenderDrawBlendMode_IntPtr_SDL_BlendMode_t(renderer, blendMode);

        private delegate int SDL_GetRenderDrawBlendMode_IntPtr_SDL_BlendMode_t(IntPtr renderer, ref SDL_blendmode.SDL_BlendMode blendMode);
        ...
        private unsafe delegate int SDL_RenderDrawPoints_IntPtr_SDL_Point_int_t(IntPtr renderer, SDL_rect.SDL_Point* points, int count);
        ...
        public unsafe static int SDL_RenderDrawPoints(IntPtr renderer, SDL_rect.SDL_Point* points, int count) => s_SDL_RenderDrawPoints_IntPtr_SDL_Point_int_t(renderer, points, count);
        ...
        private unsafe delegate int SDL_RenderDrawLines_IntPtr_SDL_Point_int_t(IntPtr renderer, SDL_rect.SDL_Point* points, int count);
        ...
        private unsafe delegate int SDL_RenderDrawRect_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        public unsafe static int SDL_RenderDrawRect(IntPtr renderer, SDL_rect.SDL_Rect* rect) => s_SDL_RenderDrawRect_IntPtr_SDL_Rect_t(renderer, rect);

        private unsafe delegate int SDL_RenderDrawRects_IntPtr_SDL_Rect_int_t(IntPtr renderer, SDL_rect.SDL_Rect* rects, int count);
        ...
        public unsafe static int SDL_RenderDrawRects(IntPtr renderer, SDL_rect.SDL_Rect* rects, int count) => s_SDL_RenderDrawRects_IntPtr_SDL_Rect_int_t(renderer, rects, count);

        private unsafe delegate int SDL_RenderFillRect_IntPtr_SDL_Rect_t(IntPtr renderer, SDL_rect.SDL_Rect* rect);
        ...
        private unsafe delegate int SDL_RenderFillRects_IntPtr_SDL_Rect_int_t(IntPtr renderer, SDL_rect.SDL_Rect* rects, int count);
        ...
        private unsafe delegate int SDL_RenderCopy_IntPtr_IntPtr_SDL_Rect_SDL_Rect_t(IntPtr renderer, IntPtr texture, SDL_rect.SDL_Rect* srcrect, SDL_rect.SDL_Rect* dstrect);
        ...
        private unsafe delegate int SDL_RenderCopyEx_IntPtr_IntPtr_SDL_Rect_SDL_Rect_double_SDL_Point_SDL_RendererFlip_t(IntPtr renderer, IntPtr texture, SDL_rect.SDL_Rect* srcrect, SDL_rect.SDL_Rect* dstrect, double angle, SDL_rect.SDL_Point* center, SDL_RendererFlip flip);
