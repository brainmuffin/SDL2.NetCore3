...
namespace SDL2.NetCore3
{
    public static class SDL_video
    {
        ...
        private delegate int SDL_GetDisplayBounds_int_SDL_Rect_t(int displayIndex, ref SDL_rect.SDL_Rect rect);
        ...
        public static int SDL_GetDisplayBounds(int displayIndex, ref SDL_rect.SDL_Rect rect) => s_SDL_GetDisplayBounds_int_SDL_Rect_t(displayIndex, ref rect);
        ...
        private delegate void SDL_SetWindowIcon_IntPtr_SDL_Surface_t(IntPtr window, ref SDL_surface.SDL_Surface icon);
        ...
        private delegate int SDL_UpdateWindowSurfaceRects_IntPtr_SDL_Rect_int_t(IntPtr window, ref SDL_rect.SDL_Rect rects, int numrects);
        ...
        public static int SDL_UpdateWindowSurfaceRects(IntPtr window, ref SDL_rect.SDL_Rect rects, int numrects) => s_SDL_UpdateWindowSurfaceRects_IntPtr_SDL_Rect_int_t(window, ref rects, numrects);
